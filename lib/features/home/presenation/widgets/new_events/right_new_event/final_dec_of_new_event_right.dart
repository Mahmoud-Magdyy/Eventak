...
class DecOfNewEventRight extends StatelessWidget {
  const DecOfNewEventRight({
    super.key, required this.nameOfEvent, required this.titleDateOfTicket, required this.subTitleDateOfTicket, required this.titleLocationOfEvent, required this.subTitleLocationOfEvent, required this.titlePriceOfEvent, required this.subTitlePriceOfEvent,
  });
          ...
          BlocBuilder<GlobalCubit, GlobalState>(
            builder: (context, state) {
              return Stack(children: [
                Transform.rotate(
                  angle: BlocProvider.of<GlobalCubit>(context)
                              .langCode ==
                          'ar'
                      ? 3.14
                      : 0.0,
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomListTileTitmeOfEvent(
                        ...
                        textSubTitle: subTitleDateOfTicket,
                      ),
                      const SizedBox(
                        height: 20,
                      ),
