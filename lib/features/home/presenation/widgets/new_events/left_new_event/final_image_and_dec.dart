...
class ImageAndDecOfNewEventLeft extends StatelessWidget {
  const ImageAndDecOfNewEventLeft({
    super.key, required this.dateDay, required this.monthDay, required this.categoryIcon, required this.imageEvent, required this.textOfNewEvent, required this.nameOfCategoryEvent,
  });
